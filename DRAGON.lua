...
DRAGON_Msg = 'اعلا تفاعل'
elseif msgs < 5500 then 
DRAGON_Msg = 'احسن تفاعل' 
elseif msgs < 7000 then 
DRAGON_Msg = 'ملك التفاعل' 
elseif msgs < 9500 then 
DRAGON_Msg = 'اجمد واحد بيتفاعل' 
elseif msgs < 10000000000 then 
DRAGON_Msg = 'تع خد قلبي يستا'  
end 
return DRAGON_Msg 
end
...
if not database:get(bot_id..'WOLFt:Time'..msg.sender_user_id_) then
local WOLFt = database:get(bot_id.."WOLFt:Bot")  
if WOLFt then 
SourceDRAGONr = WOLFt
else
...
database:setex(bot_id..'WOLFt:Time'..msg.sender_user_id_,300,true)
return false
end
...
if text and database:get(bot_id..'WOLFt:Bots') then
if text == 'الغاء' or text == 'الغاء' then   
send(msg.chat_id_, msg.id_,' ✶ الغاء حفظ كليشه ولفت')
database:del(bot_id..'WOLFt:Bots') 
return false
end
database:set(bot_id.."WOLFt:Bot",text)  
send(msg.chat_id_, msg.id_,' ✶ تم حفظ كليشه ولفت')
database:del(bot_id..'WOLFt:Bots') 
return false
end
if text == 'ضع كليشه ستارت' and DevSoFi(msg) then 
database:set(bot_id..'WOLFt:Bots',true) 
send(msg.chat_id_, msg.id_,' ✶ ارسل لي الكليشه الان')
return false
end
if text == 'حذف كليشه ستارت' and DevSoFi(msg) then 
database:del(bot_id..'WOLFt:Bot') 
send(msg.chat_id_, msg.id_,' ✶ تم حذف كليشه ولفت')
end
...
send(msg.chat_id_, msg.id_,' ✶ تم تحديث السورس \n ✶ لديك اخر اصدار لسورس ولف\n ✶ الاصدار ⤶ { v 1.5}')
dofile('DRAGON.lua')  
end
if text == 'الاصدار ' and DevSoFi(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ✶ اصدار سورس ولف \n ✶ الاصدار ⤶{ v 1.5}')
end
if text == 'لوسيفار مبرمج السورس' and DevSoFi(msg) then
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
...
{{text = '⌯｟L U S E F A R✶｠⌯', url="t.me/LLucifeerr"}}, 
} 
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '⌯｟T W A S L✭｠⌯', url="t.me/gejdkdk_bot"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
function WOLFt_function(extra, result, success)
if result.id_ then
...
tdcli_function ({ID = "SearchPublicChat",username_ = username}, WOLFt_function, nil)
return false 
end
...
if text == 'السورس' or text == 'سورس' or text == 'يا سورس' or text == 'ولف' then
local Text = [[
✪WELCOM IN SOURCE WOLF✪
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '⌯LUAEFAR⌯',url="t.me/LLucifeerr"}},
{{text = '⌯HARBOKA⌯',url="t.me/dad7rboka"}},
{{text = '⌯TWASEL⌯',url="t.me/gejdkdk_bot"}},
{{text = '⌯SOURCE CH⌯', url="t.me/s_o_u_r_c_e_w_ol_f"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
local Text = [[
✭اهلا بيك في سورس ولف لو عايز بوت بكل حقوقك ع السورس تواصل معي✭
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '⌯LUSEFAR⌯',url="t.me/LLucifeerr"}},
{{text = '⌯TWASEL⌯',url="t.me/gejdkdk_bot"}},
{{text = '⌯CH⌯',url="t.me/s_o_u_r_c_e_w_ol_f"}}, 
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end

if text == 'لوسيفار' or text == 'لوسيفر' or text == 'المبرمج' then
local Text = [[
البرمج لوسيفر
]]
keyboard = {} 
...
if text == 'حربوكا' or text == 'صاحب السورس' then
local Text = [[
حربوكا صاحب السورس
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '⌯H A R B O K A⌯',url="t.me/dad7rboka"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
{{text = 'تشابه', url="https://t.me/gamee?game=DiamondRows"},{text = 'كره القدم', url="https://t.me/gamee?game=FootballWOLF"}}, 
...
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, WOLFt_function, nil)
return false
end
...
tdcli_function ({ID = "SearchPublicChat",username_ = TextEnd[4]}, WOLFt_function, nil)
return false
end
if text and text:match("^كتم (%d+)$") and Mod(msg) then
...
tdcli_function ({ID = "SearchPublicChat",username_ = text:match("^تنزيل الكل @(.*)$")}, WOLFt_function, nil)
end
...
end --الكود حصري سورس ولف يعني لو بكتهن راح اعرفك انت الاخذتهن
...
send(msg.chat_id_,msg.id_, '[يحلات عيونك..♥️🦋](t.me/s_o_u_r_c_e_w_ol_f)')
return false
end
...
send(msg.chat_id_, msg.id_, t..'≪━━━━━━WOLF━━━━━━≫\n✶ [ 𝒔𝒐𝒖𝒓𝒄𝒆 𝒔𝒐𝒐𝒐𝒏 ](t.me/s_o_u_r_c_e_w_ol_f)')
end
